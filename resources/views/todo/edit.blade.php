...
<h1 class="display-8 text-white font-weight-bold">Edit task: </h1>
...
<button class="btn btn-success" type="submit" id="button-addon2" style="background-color: #002855;"> Save</button>
</div>
</div>
</form>
</div>
